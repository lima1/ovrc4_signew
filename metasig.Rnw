...
Our survival signature did not show strong enrichments of particular pathways.
This is probably because the biological determinant factors for patient overall
survival are complicated and diverse.  Nevertheless, 25 genes in our 200-gene
signature can be enriched through TGF-$\beta$ pathway, suggesting its poor
prognostic impact on patient overall survival (Supplementary Figure \ref{fig:pathwayos}).
Secondly, 9 genes can be linked to PDGF signaling, in which the overexpression
of both receptor (PDGFA and PDGFB) and ligand (PDGFD) indicates poor outcome.
The TAF activation in the OS signature, marked by COL11A1 \cite{Tothill:2008},
is also noticed, considering the synergistic effects of TFG-$\beta$ and PDGF
in TAF activation \cite{Cirri:2012}. Functionally, 11 genes have been
demonstrated to be involved in EMT (SNAI2, ZEB1, BMI1, C13ORF15, EDNRA/ET-1,
PDGFD, SERPINE1/PAI-1, PDPN, CUX1, SERPINA1 and the downregulation of SPDEF),
which is closely related to tumor metastasis and chemoresistance to portend
poor prognosis in ovarian cancer. Recently, the emerging roles of PDGF
signaling (especially PDGFD) in EMT and cancer stem cell maintenance during
tumorigenesis have been described \cite{Devarajan:2012, Wu:2013}. In
addition, the endothelin/ET-1 pathway also positively enhance the expression of
SNAI2, thus EMT \cite{Rosano:2010, Rosano:2011}.
...
could be used as evidence of pathway activation. Phospo-Smad2/3 was selected
...
represented by duplicate scores, the average score was calculated for the IHC
intensity of each sample (listed in Table S1). A categorical system was then
applied as follows: Grade 0 (-) score 0-3; Grade 1 (+) score 4-6; Grade 2 (++)
score 7-9; Grade 3 (+++) score 9-12.  The IHC was scored by two individuals
...
metastasis may increase the chance of surgical inaccessible tumors and thus
