...
esets.f$GSE9891_eset$subtype_aocs <-
    as.factor(clinical.aocs$k[match(sampleNames(esets.f$GSE9891_eset),
    clinical.aocs$X)])

tbl.aocs <- table( esets.f$GSE9891_eset$subtype_aocs, 
...
plotKM(y=esets.f$GSE9891_eset$y, strata=esets.f$GSE9891_eset$subtype_aocs,
