...
the Affymetrix data we used in our meta-analysis. In Supplementary
...
this figure is to demonstrates the correctness of our subtype model
...
protocol of the public data and utilized different probesets.
