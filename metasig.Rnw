...
\section{Comparison with the TCGA signature}
...
signature to unique gene symbols \cite{Seal:2011} used in curatedOvarianData;
...
\clearpage
\section{Comparison with the CLOVAR signature}
...
Figure~\ref{fig:cor:risk}. Verhaak et al.  proposed a multi-variate model
