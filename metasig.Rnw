...
\section{Dependency of survival gene signature size on prediction performance}
...
The correlation of the risk scores of our meta-analysis signature and both
...
\section{Dependency of debulking gene signature size on prediction performance }
...
and unadjusted for stage and grade (shown columns 1 and 2 in Supplemental
...
In Figure~\ref{fig:qrtpcr:cor}, we show the correlation of the qRT-PCR expression
values and the Affymetrix signal intensities.
