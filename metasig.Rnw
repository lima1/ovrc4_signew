...
We the compared our signature to the TCGA signature. To apply the TCGA
...
\begin{figure}
<<elmeta,fig.width=7,fig.height=7,out.width="0.9\\textwidth",out.height="0.9\\textwidth",results='hide'>>=
...
newdata=Xs.all[[i]])@lp)
Xs.all <- c(Xs.all, lapply(esets.validation[3], .dichotomizeshortlong, l=365.25,
label="os_1yr"))
...
\subfigure[]{
<<fpcomptcga,fig.width=5.5,fig.height=9,out.width="0.4\\textwidth",out.height="0.6\\textwidth",results='hide'>>=
